...
## Current Phase
Milestone v1 complete. Phase 6 - CLI Batch Orchestration and End-to-End Validation is finished. No new implementation phase is active until the next roadmap or milestone is planned. Do not build a VideoScribe-like editor UI, and do not re-open completed phase semantics unless a verified gap requires it.
...
## Coding Rules
- Implement only the active roadmap phase and its directly required tests/docs; when no active implementation phase exists, limit work to planning, verification, or milestone closeout.
